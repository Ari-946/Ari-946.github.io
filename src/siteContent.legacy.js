// 主播昵称、文字、图片、表情包和卡片都集中在这里替换。
export const siteContent = {
  creator: {
    name: 'LUMI', chineseName: '露米', handle: '@LUMI_LIVE', role: '游戏主播 · 虚拟冒险家',
    slogan: '把每一个普通夜晚，\n变成值得收藏的瞬间。',
    description: '这里是为露米建立的非官方应援小站。收录直播中的高能瞬间、可爱表情和限定收藏卡，也保存我们一起度过的快乐时光。',
    roomId: '888 107 26', followers: '128W', liveDays: '1,426', clips: '376', email: 'hello@lumifan.club', liveUrl: '#',
