...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ca(e,t,n){return new $r({name:`SphericalGaussianBlur`,defines:{SAMPLES:ca,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Ea(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wa(){return new $r({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ea(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ta(){return new $r({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ea(),fragmentShader:`
	...
	`}var Da=class extends Dt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var $o={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function es(e,t){let n=$o[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ts=new J;function ns(){return X.getLuminanceCoefficients(ts),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ts.x.toFixed(4)}, ${ts.y.toFixed(4)}, ${ts.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Go(i,i.VERTEX_SHADER,y),S=Go(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Zo(i,x,`vertex`),n=Zo(i,S,`fragment`);G(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main(){
  ...
  gl_FragColor=vec4(0.);
}`;function gc({color:e=`#fff`,flakeSize:t=.01,minFlakeSize:n=1.25,pixelResolution:i=200,speed:a=1.25,depthFade:o=8,farPlane:s=20,brightness:c=1,gamma:l=.4545,density:u=.3,variant:d=`square`,direction:f=125,className:p=``,style:m={}}){let h=(0,r.useRef)(null),g=(0,r.useRef)(0),_=(0,r.useRef)(!0),v=(0,r.useRef)(null),y=(0,r.useRef)(null),b=(0,r.useRef)(null),x=(0,r.useMemo)(()=>d===`round`?1:d===`snowflake`?2:0,[d]),S=(0,r.useMemo)(()=>{let t=new Z(e);return new J(t.r,t.g,t.b)},[e]),C=(0,r.useCallback)(()=>{clearTimeout(b.current),b.current=setTimeout(()=>{let e=h.current,t=v.current,n=y.current;if(!e||!t||!n)return;let r=e.offsetWidth,i=e.offsetHeight;t.setSize(r,i),n.uniforms.uResolution.value.set(r,i)},100)},[]);return(0,r.useEffect)(()=>{let e=h.current;if(!e)return;let t=new IntersectionObserver(([e])=>{_.current=e.isIntersecting});return t.observe(e),()=>t.disconnect()},[]),(0,r.useEffect)(()=>{let e=h.current;if(!e)return;let r=new pn,d=new Ai(-1,1,1,-1,0,1),p=new fc({antialias:!1,alpha:!0,premultipliedAlpha:!1,powerPreference:`high-performance`,stencil:!1,depth:!1});p.setPixelRatio(Math.min(devicePixelRatio,2)),p.setSize(e.offsetWidth,e.offsetHeight),p.setClearColor(0,0),e.appendChild(p.domElement),v.current=p;let m=new $r({vertexShader:mc,fragmentShader:hc,uniforms:{uTime:{value:0},uResolution:{value:new q(e.offsetWidth,e.offsetHeight)},uFlakeSize:{value:t},uMinFlakeSize:{value:n},uPixelResolution:{value:i},uSpeed:{value:a},uDepthFade:{value:o},uFarPlane:{value:s},uColor:{value:S.clone()},uBrightness:{value:c},uGamma:{value:l},uDensity:{value:u},uVariant:{value:x},uDirection:{value:f*Math.PI/180}},transparent:!0});y.current=m;let w=new Wr(2,2);r.add(new jr(w,m)),addEventListener(`resize`,C);let T=performance.now(),E=()=>{g.current=requestAnimationFrame(E),_.current&&(m.uniforms.uTime.value=(performance.now()-T)*.001,p.render(r,d))};return E(),()=>{cancelAnimationFrame(g.current),removeEventListener(`resize`,C),clearTimeout(b.current),e.contains(p.domElement)&&e.removeChild(p.domElement),p.dispose(),p.forceContextLoss(),w.dispose(),m.dispose(),v.current=null,y.current=null}},[C]),(0,r.useEffect)(()=>{let e=y.current;e&&(Object.assign(e.uniforms.uFlakeSize,{value:t}),e.uniforms.uMinFlakeSize.value=n,e.uniforms.uPixelResolution.value=i,e.uniforms.uSpeed.value=a,e.uniforms.uDepthFade.value=o,e.uniforms.uFarPlane.value=s,e.uniforms.uBrightness.value=c,e.uniforms.uGamma.value=l,e.uniforms.uDensity.value=u,e.uniforms.uVariant.value=x,e.uniforms.uDirection.value=f*Math.PI/180,e.uniforms.uColor.value.copy(S))},[t,n,i,a,o,s,c,l,u,x,f,S]),(0,pc.jsx)(`div`,{ref:h,className:`pixel-snow-container ${p}`,style:m})}export{gc as default};